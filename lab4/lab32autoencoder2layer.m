...
softnet = trainSoftmaxLayer(feat2,bindatatarget','MaxEpochs',40);
...
title("confusion plot 2 layer autoencoder")
...
figure(2)
plotconfusion(bintestdatatarget',y);
title("confusion plot 2 layer autoencoder backproptuned")
